...
I do freedom tech stuff. I rant about lightning. I'm interested in AI. I want to combine all of these (minus the ranting) into something that pushes the quest for freedom one step forward.

I build various things - check them out [here](https://github.com/aljazceru?ref=disobey.dev). I run a few [directories](https://disobey.dev/directories/). You can see a list of talks, interviews and podcasts, together with slides I've done here.

I started bolt.observer with the mission of making lightning nodes less painful to run. You can read more about it on bolt.observer's blog.

I started Bitcoin Ljubljana meetup in order to have more people to talk about Bitcoin with. It has become very successful and ended up being much more than just that. You can read the story about it here.

I was part of the experiment called SEC-01, short for Sovereign Engineering Cohort - 01,
...
- High availability infrastructure design for real-time energy sector applications
...
- [Managed lightning network infrastructure](https://blog.bitstamp.net/post/connect-bitstamps-lightning-node/)
- [Zebedee lightning topup integration](https://bitcoinmagazine.com/culture/bitstamp-and-zebedee-bridge-major-gap-between-bitcoin-and-gaming)
- [Integrated first Nasdaq/Cinnober matching engine in cloud env](https://www.tradersmagazine.com/departments/brokerage/bitstamp-integrates-nasdaq-matching-engine/)
